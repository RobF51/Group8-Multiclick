...
public class MyCustomAdapterPEnviados extends ArrayAdapter<String> {

    private final List<String> listaPPendientes;
    private final Context context;

    public MyCustomAdapterPEnviados(Context context, List<String> listaPPendientes) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, VendedorPedidoEnviadoInfo.class);
